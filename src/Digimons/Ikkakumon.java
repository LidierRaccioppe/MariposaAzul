...
public class Ikkakumon extends Digimon{

    public Ikkakumon() {
    }

    public Ikkakumon(String nombre, String etapaDigievolutiva, float maxHP, float vidaActual, int nivel, int XP, float fuerza, float defensa, float agilidad) {
    ...
    public Digimon crecimientoDigimon(Digimon digimonPorCrecer, int restaEntreNivelOriginalYNivelObtenido){
        ...
        if(restaEntreNivelOriginalYNivelObtenido!=0){
            ...
            digimonCrecido.setDefensa(digimonPorCrecer.getDefensa()*+(7 * restaEntreNivelOriginalYNivelObtenido));
